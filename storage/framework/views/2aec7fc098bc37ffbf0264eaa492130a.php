<?php $__env->startSection('title', 'Fotos de categorías'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="flex items-end justify-between">
        ...
        <a href="<?php echo e(route('configuracion.index')); ?>" class="rounded-xl px-3 py-2 text-sm font-semibold text-zinc-700 ring-1 ring-inset ring-zinc-200 hover:bg-zinc-50">Volver</a>
    </div>

    <form class="mt-6" method="POST" action="<?php echo e(route('configuracion.landing-category-photos.update')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <section class="rounded-3xl border border-zinc-200 bg-white p-6">
            <div class="space-y-8">
                <div>
                    ...
                    <p class="mt-2 text-xs text-zinc-500">Actual: <?php echo e($landingCategoryPhotos['ninos_uploaded_name'] ?? 'imagen por defecto'); ?></p>
                    <?php if(!empty($landingCategoryPhotos['has_uploaded_ninos'])): ?>
                    ...
                    <?php endif; ?>
                    <div class="relative mt-3 w-full max-w-[360px] overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-100" style="min-height: <?php echo e($previewCardHeight); ?>px;">
                        <img id="ninosImagePreview" src="<?php echo e($landingCategoryPhotos['ninos_image'] ?? '/images/Niños.png'); ?>" alt="Vista previa niños" class="h-full w-full object-cover" loading="lazy" style="min-height: <?php echo e($previewCardHeight); ?>px;">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs text-zinc-500">Actual: <?php echo e($landingCategoryPhotos['mujeres_uploaded_name'] ?? 'imagen por defecto'); ?></p>
                    <?php if(!empty($landingCategoryPhotos['has_uploaded_mujeres'])): ?>
                    ...
                    <?php endif; ?>
                    <div class="relative mt-3 w-full max-w-[360px] overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-100" style="min-height: <?php echo e($previewCardHeight); ?>px;">
                        <img id="mujeresImagePreview" src="<?php echo e($landingCategoryPhotos['mujeres_image'] ?? '/images/Mujer.png'); ?>" alt="Vista previa mujeres" class="h-full w-full object-cover" loading="lazy" style="min-height: <?php echo e($previewCardHeight); ?>px;">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs text-zinc-500">Actual: <?php echo e($landingCategoryPhotos['hombres_uploaded_name'] ?? 'imagen por defecto'); ?></p>
                    <?php if(!empty($landingCategoryPhotos['has_uploaded_hombres'])): ?>
                    ...
                    <?php endif; ?>
                    <div class="relative mt-3 w-full max-w-[360px] overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-100" style="min-height: <?php echo e($previewCardHeight); ?>px;">
                        <img id="hombresImagePreview" src="<?php echo e($landingCategoryPhotos['hombres_image'] ?? '/images/Hombre.png'); ?>" alt="Vista previa hombres" class="h-full w-full object-cover" loading="lazy" style="min-height: <?php echo e($previewCardHeight); ?>px;">
