<?php $__env->startSection('title', 'Editar gafa (Mujer)'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form class="mt-6" action="<?php echo e(route('admin.gafas-mujeres.update', $producto)); ?>" method="POST" enctype="multipart/form-data" data-single-submit>
        <?php echo csrf_field(); ?>
