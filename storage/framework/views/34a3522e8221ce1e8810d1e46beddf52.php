            ...
            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:660px; background:#ffffff; border:1px solid #dbe4f2; border-radius:24px; overflow:hidden; box-shadow:0 20px 40px rgba(20, 33, 61, 0.08);">
                ...
                <tr>
                    <td style="padding:28px 24px 8px 24px; text-align:center;">
                        ...
                        <p style="margin:0; font-size:16px; line-height:1.6; color:#475569;">Hola <?php echo e($clienteNombre); ?>, tu pedido ya fue enviado a tu direccion.</p>
                    </td>
                </tr>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background:#f8fbff; border:1px solid #d9e6f8; border-radius:16px;">
                            <tr>
                                <td style="padding:16px 16px 14px 16px;">
                                    ...
                                    <p style="margin:0 0 6px 0; font-size:15px; color:#1e293b;"><strong>Referencia:</strong> <?php echo e((string) $pago->referencia); ?></p>
                                    <p style="margin:0 0 6px 0; font-size:15px; color:#1e293b;"><strong>Fecha de envio:</strong> <?php echo e(optional($pago->envio_marcado_en ?? now())->format('Y-m-d H:i')); ?></p>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background:#ffffff; border:1px solid #e2e8f0; border-radius:16px;">
                            <tr>
                                <td style="padding:16px;">
                                    ...
                                    <p style="margin:0 0 6px 0; font-size:14px; color:#334155;"><strong>Nombre:</strong> <?php echo e($clienteNombre); ?></p>
                                    <?php if($clienteCorreo !== ''): ?>
                                        <p style="margin:0 0 6px 0; font-size:14px; color:#334155;"><strong>Correo:</strong> <?php echo e($clienteCorreo); ?></p>
                                    <?php endif; ?>
                                    <?php if($clienteDocumento !== ''): ?>
                                        <p style="margin:0 0 6px 0; font-size:14px; color:#334155;"><strong>Documento:</strong> <?php echo e($clienteDocumento); ?></p>
                                    <?php endif; ?>
                                    <?php if($clienteTelefono !== ''): ?>
                                        <p style="margin:0 0 6px 0; font-size:14px; color:#334155;"><strong>Telefono:</strong> <?php echo e($clienteTelefono); ?></p>
                                    <?php endif; ?>
                                    <?php if($clienteCiudad !== ''): ?>
                                        <p style="margin:0 0 6px 0; font-size:14px; color:#334155;"><strong>Ciudad:</strong> <?php echo e($clienteCiudad); ?></p>
                                    <?php endif; ?>
                                    <?php if($clienteDireccion !== ''): ?>
                                        <p style="margin:0; font-size:14px; color:#334155;"><strong>Direccion:</strong> <?php echo e($clienteDireccion); ?></p>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="padding:20px 24px 0 24px; text-align:center;">
                        ...
                        <a href="<?php echo e($seguimientoUrl); ?>" style="display:inline-block; background:linear-gradient(135deg, #0b7a75 0%, #0a9e8d 100%); color:#ffffff; text-decoration:none; font-size:15px; font-weight:700; letter-spacing:.2px; border-radius:14px; padding:13px 22px;">
                            Ver seguimiento de pedido
                        </a>
                        <p style="margin:12px 0 0 0; font-size:12px; color:#64748b; word-break:break-all;"><?php echo e($seguimientoUrl); ?></p>
                    </td>
                </tr>
...
<?php /**PATH C:\Users\norla\Desktop\Proyectos con Ronaldo\copia_optica\resources\views/emails/user/pedido_enviado.blade.php ENDPATH**/ ?>