<?php $__env->startSection('title', 'Agregar gafa (Niños)'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="flex items-center justify-between gap-3">
        <div>
            ...
            <p class="mt-1 text-sm text-zinc-500">Se publicará en /gafas-niños (si está activa).</p>
        </div>
    ...
    <form class="mt-6" action="<?php echo e(route('admin.gafas-ninos.store')); ?>" method="POST" enctype="multipart/form-data" data-single-submit>
        <?php echo csrf_field(); ?>
