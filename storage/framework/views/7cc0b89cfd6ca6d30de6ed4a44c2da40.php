<?php $__env->startSection('title', 'Gafas mujer'); ?>
<?php $__env->startSection('heading', 'Gafas mujer'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-6 rounded-3xl border border-zinc-200 bg-white p-5">
        ...
        <form class="mt-4" action="<?php echo e(route('admin.gafas-mujeres.promo-image.update')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">
                ...
                <div class="overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-50">
                    <img src="<?php echo e($promoPreview); ?>" alt="Vista previa banner mujeres" class="h-56 w-full object-cover" loading="lazy">
                </div>
            </div>
                    ...
                    <div class="mt-2 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
                        <?php $__currentLoopData = $promoAssets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promoAsset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="relative overflow-hidden rounded-xl border border-zinc-200 bg-zinc-50">
                                ...
                                <?php endif; ?>
                                <img src="<?php echo e($promoImageUrl); ?>" alt="Banner mujeres" class="h-24 w-full object-cover" loading="lazy">
                            </div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="<?php echo e(route('admin.gafas-mujeres.import.show')); ?>" class="inline-flex items-center justify-center rounded-2xl border border-zinc-200 bg-white px-4 py-2 text-sm font-semibold text-zinc-700 hover:bg-zinc-50">
                ⬆ Importar Excel
            </a>
            <a href="<?php echo e(route('admin.gafas-mujeres.create')); ?>" class="inline-flex items-center justify-center rounded-2xl bg-zinc-950 px-4 py-2 text-sm font-semibold text-white hover:bg-zinc-900">
                + Agregar
            </a>
        </div>
    </div>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('admin.gafas-mujeres.edit', $producto)); ?>" class="rounded-xl border border-zinc-200 bg-white px-3 py-2 text-sm font-semibold text-zinc-700 hover:bg-zinc-50">Editar</a>
                                <form action="<?php echo e(route('admin.gafas-mujeres.destroy', $producto)); ?>" method="POST" onsubmit="return confirm('¿Eliminar esta gafa?')">
                                    <?php echo csrf_field(); ?>
    ...
    <div class="mt-6">
        <a href="<?php echo e(route('gafas-mujeres.index')); ?>" class="text-sm font-semibold text-zinc-700 hover:underline">Ver página pública: /gafas-mujeres</a>
    </div>

    <?php echo $__env->make('admin.partials.auto_refresh', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.dashboard_empty_sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\norla\Desktop\Proyectos con Ronaldo\copia_optica\resources\views/admin/gafas_mujeres/index.blade.php ENDPATH**/ ?>