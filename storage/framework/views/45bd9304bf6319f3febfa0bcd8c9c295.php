<?php $__env->startSection('title', 'Editar gafa (Hombre)'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form class="mt-6" action="<?php echo e(route('admin.gafas-hombre.update', $producto)); ?>" method="POST" enctype="multipart/form-data" data-single-submit>
        <?php echo csrf_field(); ?>
