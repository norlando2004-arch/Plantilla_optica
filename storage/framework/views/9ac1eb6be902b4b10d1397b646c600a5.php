<?php $__env->startSection('title', 'Franja de beneficios'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form class="mt-6" method="POST" action="<?php echo e(route('configuracion.landing-benefit-strip.update')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <section class="rounded-3xl border border-zinc-200 bg-white p-6">
            ...
            ><?php echo e(old('items_text', implode("\n", $items))); ?></textarea>
