        ...
        <div class="auth-shell-inner">
            ...
            <main class="auth-panel" aria-label="Panel de registro de cuenta">
                ...
                <section class="auth-panel-main" aria-label="Formulario de registro">
                    ...
                    <form id="registerForm" method="POST" action="<?php echo e(route('register')); ?>" novalidate>
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\norla\Desktop\Proyectos con Ronaldo\copia_optica\resources\views/auth/register.blade.php ENDPATH**/ ?>