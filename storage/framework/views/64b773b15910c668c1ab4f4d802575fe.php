...
<div class="grid gap-5">
    <div class="grid gap-2">
        ...
        <input name="nombre" value="<?php echo e(old('nombre', $isEdit ? $producto->nombre : '')); ?>" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" required />
    </div>

    <div class="grid gap-5 md:grid-cols-2">
        <div class="grid gap-2">
            <label class="text-sm font-semibold text-zinc-700">Categoría</label>
            <input type="hidden" name="categoria" value="<?php echo e($categoriaModuloDefault); ?>" />
            <div class="w-full rounded-2xl border border-zinc-200 bg-zinc-100 px-4 py-3 text-sm font-medium text-zinc-700"><?php echo e($categoriaLabel); ?></div>
        </div>
        <div class="grid gap-2">
            <label class="text-sm font-semibold text-zinc-700">Material</label>
            <input name="material_montura" value="<?php echo e($materialDefault); ?>" placeholder="TR90" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
        </div>
    </div>
    ...
    <div class="grid gap-5 md:grid-cols-2">
        <div class="grid gap-2">
            ...
            <input name="recomendado_para" value="<?php echo e($recomendadoParaDefault); ?>" placeholder="Cara de sandía (forma ovalada)" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
        </div>
        <div class="grid gap-2">
            ...
            <select name="clip_on_compatible" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400">
                <option value="0" <?php echo e($clipOnCompatibleDefault === '0' ? 'selected' : ''); ?>>No</option>
                <option value="1" <?php echo e($clipOnCompatibleDefault === '1' ? 'selected' : ''); ?>>Sí</option>
            </select>
        </div>
    </div>
    ...
    <div class="grid gap-2">
        ...
        <div class="grid gap-5 md:grid-cols-2">
            <div class="grid gap-2">
                ...
                <input name="ancho_total_montura" inputmode="decimal" value="<?php echo e(old('ancho_total_montura', $fmtCm($medidas['ancho_total_montura_cm'] ?? null))); ?>" placeholder="13.9" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
            </div>
            <div class="grid gap-2">
                <label class="text-sm font-semibold text-zinc-700">Ancho del lente</label>
                <input name="ancho_lente" inputmode="decimal" value="<?php echo e(old('ancho_lente', $fmtCm($medidas['ancho_lente_cm'] ?? null))); ?>" placeholder="5.0" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
            </div>
            <div class="grid gap-2">
                <label class="text-sm font-semibold text-zinc-700">Alto del lente</label>
                <input name="alto_lente" inputmode="decimal" value="<?php echo e(old('alto_lente', $fmtCm($medidas['alto_lente_cm'] ?? null))); ?>" placeholder="4.5" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
            </div>
            <div class="grid gap-2">
                <label class="text-sm font-semibold text-zinc-700">Puente</label>
                <input name="puente" inputmode="decimal" value="<?php echo e(old('puente', $fmtCm($medidas['puente_cm'] ?? null))); ?>" placeholder="1.9" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
            </div>
            <div class="grid gap-2 md:col-span-2">
                <label class="text-sm font-semibold text-zinc-700">Largo de patillas</label>
                <input name="largo_patillas" inputmode="decimal" value="<?php echo e(old('largo_patillas', $fmtCm($medidas['largo_patillas_cm'] ?? null))); ?>" placeholder="14.2" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-2">
        ...
        <input name="incluye" value="<?php echo e($incluyeDefault); ?>" placeholder="Estuche, microfibra y pin" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
    </div>
        ...
        <div class="mt-4 grid gap-5 md:grid-cols-2">
            <div class="grid gap-2">
                ...
                <select name="progresivos" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400">
                    <option value="0" <?php echo e($compatProgresivosDefault === '0' ? 'selected' : ''); ?>>No</option>
                    <option value="1" <?php echo e($compatProgresivosDefault === '1' ? 'selected' : ''); ?>>Sí</option>
                </select>
            </div>
            <div class="grid gap-2">
                <label class="text-sm font-semibold text-zinc-700">Tipo de fórmula</label>
                <input name="tipo_formula" value="<?php echo e($tipoFormulaDefault); ?>" placeholder="Bajas" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
            </div>
            <div class="grid gap-2">
                ...
                <select name="poly" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400">
                    <option value="0" <?php echo e($compatPolyDefault === '0' ? 'selected' : ''); ?>>No</option>
                    <option value="1" <?php echo e($compatPolyDefault === '1' ? 'selected' : ''); ?>>Sí</option>
                </select>
            </div>
            <?php if(!empty($showFormulaPermitida)): ?>
                <div class="grid gap-2 md:col-span-2">
    ...
    <div class="grid gap-5 md:grid-cols-2">
        <div class="grid gap-2">
            ...
            <input name="precio" inputmode="decimal" value="<?php echo e(old('precio', $precioDefault)); ?>" placeholder="50.000" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" required />
        </div>
        <div class="grid gap-2">
            <label class="text-sm font-semibold text-zinc-700">Precio oferta (opcional)</label>
            <input name="precio_oferta" inputmode="decimal" value="<?php echo e(old('precio_oferta', $precioOfertaDefault)); ?>" placeholder="45.000" class="w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
        </div>
    </div>
    ...
    <div class="grid gap-5 md:grid-cols-2">
        <div class="grid gap-2">
            ...
            <input name="existencias" type="number" min="0" value="<?php echo e(old('existencias', $isEdit ? $producto->existencias : '')); ?>" readonly tabindex="-1" class="w-full cursor-not-allowed rounded-2xl border border-zinc-200 bg-zinc-100 px-4 py-3 text-sm text-zinc-700 outline-none" />
        </div>
        ...
        <label class="flex items-center gap-3 rounded-2xl border border-zinc-200 bg-white px-4 py-3">
            ...
            <input type="checkbox" name="esta_activo" value="1" class="h-4 w-4 rounded border-zinc-300" <?php echo e(old('esta_activo', $isEdit ? $producto->esta_activo : true) ? 'checked' : ''); ?> />
    ...
    <div class="grid gap-2">
        ...
        <textarea name="descripcion" rows="5" class="w-full resize-y rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400"><?php echo e(old('descripcion', $isEdit ? $producto->descripcion : '')); ?></textarea>
    </div>
    ...
    <div class="rounded-3xl border border-zinc-200 bg-white p-5">
        ...
        <?php if($isEdit && $img): ?>
            <div class="mt-4 flex items-center gap-4">
                <img src="<?php echo e($img); ?>" alt="<?php echo e(e($producto->nombre)); ?>" class="h-20 w-20 rounded-2xl border border-zinc-200 object-cover" />
        ...
        <div class="mt-4">
            ...
            <?php if($isEdit && !empty($meta['uploaded_imagen_name'])): ?>
                <p class="mt-2 text-xs font-semibold text-emerald-700">Imagen subida guardada: <?php echo e($meta['uploaded_imagen_name']); ?></p>
            <?php endif; ?>

            <div id="gafaMujerUploadedPreviewCard" class="mt-3 <?php echo e($img ? '' : 'hidden'); ?> max-w-[320px] rounded-2xl border border-zinc-200 bg-zinc-50 p-3">
                ...
                <div class="mt-2 overflow-hidden rounded-2xl border border-zinc-200 bg-white">
                    <div class="relative aspect-[4/3] w-full bg-zinc-100">
                        <img
                            ...
                            src="<?php echo e($img ?: $placeholderImg); ?>"
                ...
                <div class="mt-3 min-w-0">
                    <p id="gafaMujerUploadedInlineName" class="truncate text-xs font-semibold text-zinc-700"><?php echo e($isEdit && !empty($meta['uploaded_imagen_name']) ? $meta['uploaded_imagen_name'] : 'La imagen aparecerá aquí al seleccionarla'); ?></p>
            ...
            <div id="gafaMujerColorPrompt" class="mt-4 rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
                <p class="text-sm font-semibold text-zinc-800">Color principal: <span id="gafaMujerColorText"><?php echo e($frameColorDefault); ?></span></p>
                ...
                <div class="mt-3 flex flex-wrap items-center gap-2" id="colorCheckboxGroup">
                    <?php $__currentLoopData = $frameColorOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="inline-flex cursor-pointer items-center">
                            <input
                                ...
                                data-color-name="<?php echo e($option['name']); ?>"
                                data-color-hex="<?php echo e($option['hex']); ?>"
                                <?php echo e(in_array($option['name'], old('color', $frameColorDefaultList), true) ? 'checked' : ''); ?>

                            />
                            <span class="inline-flex h-9 w-9 rounded-full border-2 border-white shadow-sm ring-2 ring-zinc-300 transition peer-checked:ring-zinc-800" style="background-color: <?php echo e($option['hex']); ?>;"></span>
                        </label>
                ...
                <div class="mt-3 max-w-[220px]">
                    ...
                    <input id="gafaMujerPrimaryColorStock" type="number" min="0" value="<?php echo e($frameColorStockDefault); ?>" placeholder="0" class="mt-2 w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm outline-none focus:border-zinc-400" />
                    <div id="gafaMujerPrimaryColorStockHiddenInputs"></div>
                </div>

                <?php $__errorArgs = ['color_stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="mt-3 text-sm font-semibold text-rose-700"><?php echo e($message); ?></p>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-4">
            ...
            <?php if($existingColorVariants !== []): ?>
                <div class="mt-3 rounded-2xl border border-zinc-200 bg-zinc-50 p-3">
                    ...
                    <div class="mt-3 grid gap-3 sm:grid-cols-2">
                        <?php $__currentLoopData = $existingColorVariants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variantIndex => $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="rounded-2xl border border-zinc-200 bg-white p-3" data-existing-variant-card="<?php echo e($variantIndex); ?>">
                                <div class="flex items-center justify-between gap-2">
                                    <p class="text-xs font-semibold text-zinc-800">Colores actuales: <span data-existing-variant-name-label><?php echo e($variant['name']); ?></span></p>
                                    <?php if($variant['stock'] !== null): ?>
                                        <p class="text-[11px] font-semibold text-zinc-500">Stock actual: <?php echo e($variant['stock']); ?></p>
                                    <?php endif; ?>
                                </div>

                                <input type="hidden" name="existing_color_variants[<?php echo e($variantIndex); ?>][name]" value="<?php echo e($variant['name']); ?>" data-existing-variant-name />
                                <input type="hidden" data-existing-variant-colors value="<?php echo e(implode(',', $variant['names'] ?? [$variant['name']])); ?>" />

                                <?php $__currentLoopData = $variant['images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <input type="hidden" name="existing_color_variants[<?php echo e($variantIndex); ?>][images][]" value="<?php echo e($imgUrl); ?>" />
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>


                                <div class="mt-2 grid grid-cols-3 gap-2">
                                    <?php $__currentLoopData = $variant['images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgIdx => $imgUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="relative aspect-square overflow-hidden rounded-xl border border-zinc-200 bg-zinc-50">
                                            <input type="number" name="existing_color_variants[<?php echo e($variantIndex); ?>][images_order][<?php echo e($imgIdx); ?>]" value="<?php echo e($imgIdx + 1); ?>" min="1" step="1" inputmode="numeric" pattern="[0-9]*" class="absolute top-1 left-1 z-10 w-8 h-8 rounded-full bg-zinc-800 text-white text-xs font-bold text-center opacity-80 select-none border-0 outline-none no-spinner" style="padding-left:0.5em;pointer-events:auto;" title="Orden de la imagen" oninput="handleImageOrderInputRealtime(this, <?php echo e($variantIndex); ?>)" onkeydown="return handleImageOrderKeydown(event, this, <?php echo e($variantIndex); ?>)" />
                                            <script>
                                            ...
                                            <img src="<?php echo e($imgUrl); ?>" alt="<?php echo e($variant['name']); ?>" class="absolute inset-0 h-full w-full object-cover" loading="lazy" />
                                            <!-- Botón eliminar imagen guardada -->
                                            <button type="button" class="absolute top-1 right-1 z-10 p-0 rounded-full bg-white shadow hover:bg-red-100 border border-red-300" style="width:22px;height:22px;display:flex;align-items:center;justify-content:center;" title="Eliminar imagen" onclick="this.closest('.relative').style.display='none'; this.nextElementSibling.value='<?php echo e($imgUrl); ?>';">
                                            ...
                                            <input type="hidden" name="existing_color_variants[<?php echo e($variantIndex); ?>][delete_images][]" value="" />
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                    ...
                                    <div class="mt-2 flex flex-wrap items-center gap-2">
                                        <?php $__currentLoopData = $frameColorOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="inline-flex cursor-pointer items-center">
                                                <input
                                                    type="checkbox"
                                                    name="existing_variant_color_pick_<?php echo e($variantIndex); ?>[]"
                                                    value="<?php echo e($option['name']); ?>"
                                                    class="peer sr-only"
                                                    data-existing-variant-color-checkbox="<?php echo e($variantIndex); ?>"
                                                    <?php echo e(in_array($option['name'], $variant['names'] ?? [$variant['name']], true) ? 'checked' : ''); ?>

                                                />
                                                <span class="inline-flex h-8 w-8 rounded-full border-2 border-white shadow-sm ring-2 ring-zinc-300 transition peer-checked:ring-zinc-800" style="background-color: <?php echo e($option['hex']); ?>;"></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                ...
                                <div class="mt-3 max-w-[220px]">
                                    ...
                                    <input
                                        ...
                                        min="0"
                                        placeholder="0"
                                        value="<?php echo e($variant['stock'] !== null ? $variant['stock'] : ''); ?>"
                                        name="existing_color_variants[<?php echo e($variantIndex); ?>][stock]"
                                        data-existing-variant-stock="<?php echo e($variantIndex); ?>"
                                        data-existing-variant-initial-stock="<?php echo e($variant['stock'] !== null ? $variant['stock'] : ''); ?>"
                                    ...
                                    <input
                                        ...
                                        name="existing_color_variants[<?php echo e($variantIndex); ?>][stock]"
                                        value="<?php echo e($variant['stock'] !== null ? $variant['stock'] : ''); ?>"
                                        data-existing-variant-stock-hidden="<?php echo e($variantIndex); ?>"
                                    />
            ...
            <div class="mt-4 rounded-2xl border border-sky-200 bg-sky-50 p-4">
                ...
                <?php if($isEdit && $existingCameraColorVariants !== []): ?>
                    <div class="mt-4 rounded-2xl border border-zinc-200 bg-white p-3">
                        ...
                        <div class="mt-3 grid gap-3 sm:grid-cols-2">
                            <?php $__currentLoopData = $existingCameraColorVariants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cameraVariantIndex => $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-2" data-camera-variant-card="<?php echo e($cameraVariantIndex); ?>">
                                    <div class="flex items-center justify-between gap-2">
                                        <p class="text-[11px] font-semibold text-zinc-700">Grupo: <span data-camera-variant-name-label><?php echo e($variant['name']); ?></span></p>
                                    </div>

                                    <input type="hidden" name="existing_camera_variants[<?php echo e($cameraVariantIndex); ?>][name]" value="<?php echo e($variant['name']); ?>" data-camera-variant-name />
                                    <input type="hidden" data-camera-variant-colors value="<?php echo e(implode(',', $cameraVariantNames)); ?>" />

                                    <div class="mt-2 flex flex-wrap gap-2">
                                        <?php $__currentLoopData = ($variant['images'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $savedCameraImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="relative" data-camera-existing-image>
                                                <input type="hidden" name="existing_camera_variants[<?php echo e($cameraVariantIndex); ?>][images][]" value="<?php echo e($savedCameraImage); ?>" />
                                                <img src="<?php echo e($savedCameraImage); ?>" alt="<?php echo e($variant['name']); ?>" class="h-14 w-14 rounded-lg border border-zinc-200 object-cover" loading="lazy" />
                                                <button type="button" class="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center rounded-full border border-rose-300 bg-white text-rose-600" title="Eliminar imagen" onclick="this.closest('[data-camera-existing-image]').classList.add('hidden'); this.nextElementSibling.value='<?php echo e($savedCameraImage); ?>';">
                                                    <svg viewBox="0 0 20 20" fill="currentColor" class="h-3 w-3" aria-hidden="true"><path fill-rule="evenodd" d="M6.707 6.707a1 1 0 010-1.414 1 1 0 011.414 0L10 7.586l1.879-1.88a1 1 0 111.415 1.415L11.415 9l1.88 1.879a1 1 0 01-1.415 1.415L10 10.415l-1.879 1.88a1 1 0 01-1.414-1.415L8.586 9 6.707 7.121z" clip-rule="evenodd"/></svg>
                                                </button>
                                                <input type="hidden" name="existing_camera_variants[<?php echo e($cameraVariantIndex); ?>][delete_images][]" value="" />
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
        ...
        <input type="hidden" id="gafaMujerImageUrl" name="imagen_url" value="<?php echo e(old('imagen_url', $isEdit ? $manualImg : '')); ?>" />

        <div hidden>
            <input type="hidden" name="image_zoom" value="<?php echo e(number_format($zoom, 2, '.', '')); ?>">
            <input type="hidden" name="image_pos_x" value="<?php echo e((int) $posX); ?>">
            <input type="hidden" name="image_pos_y" value="<?php echo e((int) $posY); ?>">
            <input id="gafaMujerZoomPct" type="range" min="0" max="100" step="1" value="<?php echo e((int) round($zoomPct)); ?>">
            <input id="gafaMujerZoom" type="hidden" name="image_zoom" value="<?php echo e(number_format($zoom, 2, '.', '')); ?>">
            <span id="gafaMujerZoomVal"></span>
            <input id="gafaMujerPosX" name="image_pos_x" type="range" min="0" max="100" step="1" value="<?php echo e((int) $posX); ?>">
            <span id="gafaMujerPosXVal"></span>
            <input id="gafaMujerPosY" name="image_pos_y" type="range" min="0" max="100" step="1" value="<?php echo e((int) $posY); ?>">
            <span id="gafaMujerPosYVal"></span>
            <img id="gafaMujerPreviewBg" src="<?php echo e($img ?: $placeholderImg); ?>" alt="" onerror="this.onerror=null; this.src='<?php echo e($placeholderImg); ?>';">
            <img id="gafaMujerPreviewFg" src="<?php echo e($img ?: $placeholderImg); ?>" alt="" onerror="this.onerror=null; this.src='<?php echo e($placeholderImg); ?>';">
        </div>
    </div>
</div>
...
<script>
    (() => {
        ...
        const colorOptions = <?php echo json_encode($frameColorOptions, 15, 512) ?>;
        const initialColorStocks = <?php echo json_encode($colorStockMap, 15, 512) ?>;
        const initialGroupStocks = <?php echo json_encode($initialGroupStockMap, 15, 512) ?>;
        ...
        const placeholder = <?php echo json_encode($placeholderImg, 15, 512) ?>;
        const MID_ZOOM = Number(<?php echo json_encode($midZoom, 15, 512) ?>);
...
<?php /**PATH C:\Users\norla\Desktop\Proyectos con Ronaldo\copia_optica\resources\views/admin/gafas_mujeres/_form.blade.php ENDPATH**/ ?>