...
<?php $__env->startSection('title', 'Imagenes de formulas'); ?>
<?php $__env->startSection('heading', 'Imagenes de formulas'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-6">
        ...
        <div class="rounded-3xl border border-zinc-200 bg-white p-5">
            ...
            <form class="mt-4" action="<?php echo e(route('dashboard.formula-images.update')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="grid gap-4 lg:grid-cols-2">
                    <div class="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
                        ...
                        <textarea id="mono_description_text" name="mono_description_text" rows="4" maxlength="400" class="mt-2 block w-full rounded-2xl border border-zinc-200 px-4 py-3 text-sm"><?php echo e(old('mono_description_text', $formulas['mono_description'])); ?></textarea>
                        <p class="mt-1 text-[11px] text-zinc-500">Máximo 400 caracteres.</p>
                        <div class="mt-3">
                            <img src="<?php echo e($formulas['mono_icon']); ?>" alt="Icono monofocal" loading="lazy" class="h-16 w-20 object-contain sm:h-20 sm:w-24">
                        </div>
                    ...
                    <div class="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
                        ...
                        <textarea id="bifocal_description_text" name="bifocal_description_text" rows="4" maxlength="400" class="mt-2 block w-full rounded-2xl border border-zinc-200 px-4 py-3 text-sm"><?php echo e(old('bifocal_description_text', $formulas['bifocal_description'])); ?></textarea>
                        <p class="mt-1 text-[11px] text-zinc-500">Máximo 400 caracteres.</p>
                        <div class="mt-3">
                            <img src="<?php echo e($formulas['bifocal_icon']); ?>" alt="Icono bifocal" loading="lazy" class="h-16 w-20 object-contain sm:h-20 sm:w-24">
                        </div>
                    ...
                    <div class="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
                        ...
                        <textarea id="ocupacional_description_text" name="ocupacional_description_text" rows="4" maxlength="400" class="mt-2 block w-full rounded-2xl border border-zinc-200 px-4 py-3 text-sm"><?php echo e(old('ocupacional_description_text', $formulas['ocupacional_description'])); ?></textarea>
                        <p class="mt-1 text-[11px] text-zinc-500">Máximo 400 caracteres.</p>
                        <div class="mt-3">
                            <img src="<?php echo e($formulas['ocupacional_icon']); ?>" alt="Icono ocupacional" loading="lazy" class="h-16 w-20 object-contain sm:h-20 sm:w-24">
                        </div>
                    ...
                    <div class="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
                        ...
                        <div class="mt-3">
                            <img src="<?php echo e($formulas['default_lente']); ?>" alt="Lente" loading="lazy" class="h-16 w-20 object-contain sm:h-20 sm:w-24">
                            <div class="text-xs text-zinc-600"><?php echo e($formulas['default_lente_uploaded_name'] ?? 'manual/por defecto'); ?></div>
                        </div>
                    ...
                    <div class="rounded-2xl border border-zinc-200 bg-zinc-50 p-4">
                        ...
                        <textarea id="progresivo_description_text" name="progresivo_description_text" rows="4" maxlength="400" class="mt-2 block w-full rounded-2xl border border-zinc-200 px-4 py-3 text-sm"><?php echo e(old('progresivo_description_text', $formulas['progresivo_description'])); ?></textarea>
                        <p class="mt-1 text-[11px] text-zinc-500">Máximo 400 caracteres.</p>
                        <div class="mt-3">
                            <img src="<?php echo e($formulas['progresivo_icon']); ?>" alt="Icono progresivo" loading="lazy" class="h-16 w-20 object-contain sm:h-20 sm:w-24">
                        </div>
                    ...
                    <div class="lg:col-span-2 rounded-2xl border border-zinc-200 bg-white p-4">
                        ...
                        <div class="mt-3 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            <?php $__currentLoopData = $bifocalVariantCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="rounded-2xl border border-zinc-100 p-3">
                                    <div class="flex items-center gap-3">
                                        <div class="h-10 w-10 <?php echo e($card['color']); ?>">
                                        ...
                                        <div>
                                            ...
                                            <input type="file" name="<?php echo e($card['input']); ?>" accept="image/*" class="mt-2 block w-full rounded-2xl border border-zinc-200 px-3 py-2 text-sm">
                                            <textarea name="<?php echo e($card['description_input']); ?>" rows="4" maxlength="400" class="mt-2 block w-full rounded-2xl border border-zinc-200 px-3 py-2 text-sm"><?php echo e(old($card['description_input'], $formulas[$card['description_key']])); ?></textarea>
                                            <div class="mt-1 text-[11px] text-zinc-500">Texto del modulo. Maximo 400 caracteres.</div>
                                            <div class="mt-2"><img src="<?php echo e($formulas[$card['image']]); ?>" class="h-12 w-14 object-contain" alt="<?php echo e($card['alt']); ?>"></div>
                                            <label class="mt-1 inline-flex items-center gap-2 text-xs"><input type="checkbox" name="<?php echo e($card['remove']); ?>" value="1"> Quitar icono</label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-2 rounded-2xl border border-zinc-200 bg-white p-4">
                        ...
                        <div class="mt-3 grid grid-cols-2 gap-4 sm:grid-cols-4">
                            <div class="text-center">
                                <div class="mb-2 h-14 w-16 rounded-full bg-center bg-cover shadow-inner mx-auto" style="background-image: url('<?php echo e($formulas['nara_basica'] ?? url('/image/narabasico.png')); ?>');"></div>
                            ...
                            <div class="text-center">
                                <div class="mb-2 h-14 w-16 rounded-full bg-center bg-cover shadow-inner mx-auto" style="background-image: url('<?php echo e($formulas['nara_media'] ?? url('/image/naramedia.png')); ?>');"></div>
                            ...
                            <div class="text-center">
                                <div class="mb-2 h-14 w-16 rounded-full bg-center bg-cover shadow-inner mx-auto" style="background-image: url('<?php echo e($formulas['nara_alta'] ?? url('/image/naraAlta.png')); ?>');"></div>
                            ...
                            <div class="text-center">
                                <div class="mb-2 h-14 w-16 rounded-full bg-center bg-cover shadow-inner mx-auto" style="background-image: url('<?php echo e($formulas['nara_premium'] ?? url('/image/naraPREMIUM.png')); ?>');"></div>
                    ...
                    <div class="mt-4 rounded-2xl border border-zinc-200 bg-zinc-50/60 p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_azul_foto_blue_icon']); ?>" class="h-12 w-14 object-contain" alt="Nara premium AR azul foto"></div>
                        ...
                        <div class="rounded-2xl border border-zinc-100 p-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_blanco_icon']); ?>" class="h-12 w-14 object-contain" alt="Nara básica blanco"></div>
                        ...
                        <div class="rounded-2xl border border-zinc-100 p-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_azul_icon']); ?>" class="h-12 w-14 object-contain" alt="Nara básica AR azul"></div>
                        ...
                        <div class="rounded-2xl border border-zinc-100 p-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_verde_icon']); ?>" class="h-12 w-14 object-contain" alt="Nara básica AR verde"></div>
                        ...
                        <div class="rounded-2xl border border-zinc-100 p-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_azul_foto_blue_icon']); ?>" class="h-12 w-14 object-contain" alt="Nara básica AR azul foto"></div>
                                    <div class="mt-1 text-xs text-zinc-500">Comparte la imagen con Bifocales 1.56 AR azul + Fotocromático + Blue Block</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rounded-2xl border border-zinc-100 p-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_verde_foto_blue_icon']); ?>" class="h-12 w-14 object-contain" alt="Nara básica AR verde foto"></div>
                    ...
                    <div class="mt-3 grid gap-6 lg:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-3 grid gap-4 sm:grid-cols-2">
                                <div class="rounded-2xl border border-zinc-100 p-3">
                                    <div class="text-sm font-semibold">AR azul</div>
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_azul_icon']); ?>" class="h-12 w-14 object-contain" alt="Alto indice 1.67 AR azul"></div>
                                    <div class="mt-1 text-xs text-zinc-500">Comparte la imagen con Bifocales 1.56 AR azul</div>
                                </div>
                                <div class="rounded-2xl border border-zinc-100 p-3">
                                    <div class="text-sm font-semibold">AR verde</div>
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_verde_icon']); ?>" class="h-12 w-14 object-contain" alt="Alto indice 1.67 AR verde"></div>
                                    <div class="mt-1 text-xs text-zinc-500">Comparte la imagen con Bifocales 1.56 AR verde</div>
                                </div>
                                <div class="rounded-2xl border border-zinc-100 p-3">
                                    <div class="text-sm font-semibold">AR azul + Fotocromático + Blue Block</div>
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_azul_foto_blue_icon']); ?>" class="h-12 w-14 object-contain" alt="Alto indice 1.67 AR azul foto"></div>
                                    <div class="mt-1 text-xs text-zinc-500">Comparte la imagen con Bifocales 1.56 AR azul + Fotocromático + Blue Block</div>
                                </div>
                                <div class="rounded-2xl border border-zinc-100 p-3">
                                    <div class="text-sm font-semibold">AR verde + Fotocromático + Blue Block</div>
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_verde_foto_blue_icon']); ?>" class="h-12 w-14 object-contain" alt="Alto indice 1.67 AR verde foto"></div>
                                    <div class="mt-1 text-xs text-zinc-500">Comparte la imagen con Bifocales 1.56 AR verde + Fotocromático + Blue Block</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-3 grid gap-4 sm:grid-cols-2">
                                <div class="rounded-2xl border border-zinc-100 p-3">
                                    <div class="text-sm font-semibold">AR azul</div>
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_azul_icon']); ?>" class="h-12 w-14 object-contain" alt="Alto indice 1.74 AR azul"></div>
                                    <div class="mt-1 text-xs text-zinc-500">Comparte la imagen con Bifocales 1.56 AR azul</div>
                                </div>
                                <div class="rounded-2xl border border-zinc-100 p-3">
                                    <div class="text-sm font-semibold">AR verde</div>
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_verde_icon']); ?>" class="h-12 w-14 object-contain" alt="Alto indice 1.74 AR verde"></div>
                                    <div class="mt-1 text-xs text-zinc-500">Comparte la imagen con Bifocales 1.56 AR verde</div>
                                </div>
                                <div class="rounded-2xl border border-zinc-100 p-3">
                                    <div class="text-sm font-semibold">AR azul + Fotocromático + Blue Block</div>
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_azul_foto_blue_icon']); ?>" class="h-12 w-14 object-contain" alt="Alto indice 1.74 AR azul foto"></div>
                                    <div class="mt-1 text-xs text-zinc-500">Comparte la imagen con Bifocales 1.56 AR azul + Fotocromático + Blue Block</div>
                                </div>
                                <div class="rounded-2xl border border-zinc-100 p-3">
                                    <div class="text-sm font-semibold">AR verde + Fotocromático + Blue Block</div>
                                    <div class="mt-2"><img src="<?php echo e($formulas['bifocal_ar_verde_foto_blue_icon']); ?>" class="h-12 w-14 object-contain" alt="Alto indice 1.74 AR verde foto"></div>
                                    <div class="mt-1 text-xs text-zinc-500">Comparte la imagen con Bifocales 1.56 AR verde + Fotocromático + Blue Block</div>
                                </div>
                            </div>
                        </div>
