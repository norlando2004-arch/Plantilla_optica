...
<head>
    ...
    <title>Gafas niños — Óptica</title>
...
<main class="mx-auto max-w-7xl px-4 py-8">
    <div class="mb-6 text-center">
        ...
        <h1 class="mt-1 text-3xl font-extrabold tracking-tight text-zinc-900 sm:text-4xl">Gafas niños</h1>
        <p class="mt-2 text-base text-zinc-500">Colección para niños</p>
    </div>
