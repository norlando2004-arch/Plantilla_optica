...
@section('title', 'Editar gafa (Deportivas)')
...
@section('content')
    ...
    <form class="mt-6" action="{{ route('admin.gafas-descanso.update', $producto) }}" method="POST" enctype="multipart/form-data" data-single-submit>
        @csrf
        @method('PUT')
