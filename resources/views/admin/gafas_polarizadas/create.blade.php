...
@section('title', 'Agregar gafa polarizada')
...
@section('content')
    ...
    <form class="mt-6" action="{{ route('admin.gafas-polarizadas.store') }}" method="POST" enctype="multipart/form-data" data-single-submit>
        @csrf
