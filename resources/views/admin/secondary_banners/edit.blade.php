...
@section('title', 'Editar banner secundario')

@section('content')
    <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
            <h1 class="text-2xl font-semibold tracking-tight">Editar banner secundario</h1>
        </div>
    ...
    <form class="mt-6" method="POST" action="{{ route('configuracion.secondary-banners.update', $banner) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        @include('admin.secondary_banners._form', ['banner' => $banner])
