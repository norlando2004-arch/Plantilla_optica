...
@section('title', 'Importar gafas mujer')
@section('heading', 'Importar gafas mujer')

@section('content')
    <div class="mb-6 rounded-3xl border border-zinc-200 bg-white p-5">
        <div class="mb-6">
            <h3 class="text-base font-semibold text-zinc-900">Cargar gafas desde Excel</h3>
            <p class="mt-1 text-sm text-zinc-500">Sube un archivo Excel con las gafas que deseas agregar a tu catálogo de mujeres.</p>
        </div>

        <form action="{{ route('admin.gafas-mujeres.import') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a 
                    href="{{ route('admin.gafas-mujeres.import.template') }}" 
                ...
                <a 
                    href="{{ route('admin.gafas-mujeres.index') }}" 
