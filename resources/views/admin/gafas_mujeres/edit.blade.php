...
@section('title', 'Editar gafa (Mujer)')
...
@section('content')
    ...
    <form class="mt-6" action="{{ route('admin.gafas-mujeres.update', $producto) }}" method="POST" enctype="multipart/form-data" data-single-submit>
        @csrf
        @method('PUT')
