...
@section('title', 'Agregar gafa (Niños)')
...
@section('content')
    <div class="flex items-center justify-between gap-3">
        ...
        <a href="{{ route('admin.gafas-ninos.index') }}" class="rounded-xl px-3 py-2 text-sm font-semibold text-zinc-700 hover:bg-zinc-50">Volver</a>
    </div>

    <form class="mt-6" action="{{ route('admin.gafas-ninos.store') }}" method="POST" enctype="multipart/form-data" data-single-submit>
        @csrf
