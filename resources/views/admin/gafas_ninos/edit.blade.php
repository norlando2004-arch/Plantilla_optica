...
@section('title', 'Editar gafa (Niños)')
...
@section('content')
    ...
    <form class="mt-6" action="{{ route('admin.gafas-ninos.update', $producto) }}" method="POST" enctype="multipart/form-data" data-single-submit>
        @csrf
        @method('PUT')
