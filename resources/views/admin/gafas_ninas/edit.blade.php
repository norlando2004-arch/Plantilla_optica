...
@section('title', 'Editar gafa (Niñas)')
...
@section('content')
    ...
    <form class="mt-6" action="{{ route('admin.gafas-ninas.update', $producto) }}" method="POST" enctype="multipart/form-data" data-single-submit>
        @csrf
        @method('PUT')
