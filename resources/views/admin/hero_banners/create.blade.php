...
@section('title', 'Nuevo hero banner')

@section('content')
    <div class="flex items-end justify-between">
        <div>
            <h1 class="text-2xl font-semibold tracking-tight">Nuevos banners</h1>
        </div>
    ...
    <form class="mt-6" method="POST" action="{{ route('configuracion.hero-banners.store') }}" enctype="multipart/form-data">
        @csrf
        @include('admin.hero_banners._form')
